          ...
          >
            ...
            >
              ...
              <div className="mt-6 pt-4 border-t border-[#00E285] text-xs text-gray-200">
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-emerald-500 hover:bg-emerald-400 text-12px font-semibold text-[#020617] transition-colors"
                >
