...
import { submitApplicationApi } from "../../axios/api";
  ...
  return (
    <main className="min-h-screen bg-white py-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-0">
        ...
        {/* SUCCESS ALERT */}
        {successMessage && (
          <div className="mb-4 p-3 rounded-xl bg-green-600 text-white border border-green-400 text-sm">
            {successMessage}
          </div>
        )}
        ...
        {/* ERROR ALERT */}
        {error && (
          <div className="mb-4 p-3 rounded-xl bg-red-400/20 border border-red-400 text-red-700 text-sm">
            {error}
          </div>
        )}
