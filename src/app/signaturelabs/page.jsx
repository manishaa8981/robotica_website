    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 lg:px-0">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl mx-auto text-sm md:text-base text-slate-300/80">
          ...
          {labs.map((lab, index) => {
            ...
            return (
              <motion.article
                ...
                className="relative  rounded-3xl border border-beige shadow-[0_10px_10px_beige/40] overflow-hidden bg-beige/20 backdrop-blur-md"
              >
                {/* Neon border glow */}
                ...
                <div className="relative grid md:grid-cols-2 gap-8 md:gap-10 p-6 sm:p-8 lg:p-10">
                  ...
                  <div className={isEven ? "" : "md:order-2"}>
                    <div className="inline-flex items-center gap-2 px-3 py-1 mb-3 rounded-full bg-green/80 border border-green  text-[11px] uppercase tracking-[0.18em] text-slate-300/90">
